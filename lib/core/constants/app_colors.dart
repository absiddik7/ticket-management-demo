...
class AppColors {
  ...
  static const Color ticketOpen = Color(0xFF2196F3);
  static const Color ticketInProgress = Color(0xFFFFA726);
  static const Color ticketResolved = Color(0xFF66BB6A);
  static const Color ticketClosed = Color(0xFF9E9E9E);
  static const Color ticketPending = Color(0xFFAB47BC);
